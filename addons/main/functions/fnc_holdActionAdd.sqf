...
#define TEXTURE_TEMPLATE_IDLE_PULSE_FIXED(color) (format["<img size='3' shadow='0' color='%1' image='\A3\Ui_f\data\IGUI\Cfg\HoldActions\in\in_0_ca.paa'/>",color])	//frame 0-3

/*
    Author: Jiri Wainar, edited by diwako
...
[
    ...
    ["_title",LLSTRING(addPlate),[""]],
    ["_iconIdle","\a3\ui_f\data\gui\rsc\rscdisplayarsenal\vest_ca.paa",["",{}]],
    ["_iconProgress","\a3\ui_f\data\gui\rsc\rscdisplayarsenal\vest_ca.paa",["",{}]],
    ["_condShow","true",[""]],
    ["_condProgress","true",[""]],
    ["_codeStart",FUNC(addPlateActionStart),[{}]],
    ["_codeProgress",{},[{}]],
    ["_codeCompleted",FUNC(addPlateActionSuccess),[{}]],
    ["_codeInterrupted",FUNC(addPlateActionCancel),[{}]],
    ["_arguments",[],[[]]],
    ["_duration",GVAR(timeToAddPlate),[123]],
    ["_priority",1000,[123]],
    ["_removeCompleted",false,[true]],
    ["_showUnconscious",false,[true]],
    ["_showWindow",false,[true]]
];
...
if (isNil {TEXTURES_IDLE}) then
{
    ...
    for "_i" from 0 to FRAME_MAX_IDLE do
    {
        ...
        TEXTURES_IDLE pushBack TEXTURE_TEMPLATE_IDLE_PULSE_FIXED(_color);
    };
};
...
//add the action
private _actionID = _target addAction [_title, _codeInit, _arguments, _priority, _showWindow, ACTION_HIDE_ON_USE, ACTION_SHORTCUT, _condShow, 10, _showUnconscious, ""];
